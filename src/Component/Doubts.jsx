                    ...
                    <div className="col-lg-7 col-md-7 col-sm-12 m-auto"  id="doubts2" >
                        ...
                        <div className="row m-4" style={{backgroundColor :'white'}}>
                            <div className="d-flex">
                                <LinkContainer to="./doubts" ><div><button className="btn btn-success m-2 p-2 doubtslink" style={{color:'#fff'}} >All doubts</button></div></LinkContainer>
                                <LinkContainer to="/doubts/mydoubts"><div className="m-auto"><button  className="btn m-2 p-2 doubtslink" >My doubts</button></div></LinkContainer> 
                                <LinkContainer to="/doubts/askdoubts"><div className=""><button  className="btn m-2 p-2 doubtslink">Ask doubts</button></div></LinkContainer> 
